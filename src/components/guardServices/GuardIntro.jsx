...
const GuardIntro = () => {
  return (
    <div className="bg-gray-800 p-10 text-left font-mono mb-4">
      <h1 className="text-xl lg:text-5xl font-bold mb-4 text-white">ELITES LION SECURITY GUARD SERVICES</h1>
      ...
      <a href='' className="bg-lime-500 text-white py-2 px-1  rounded hover:bg-primary hover:shadow-inner hover:scale-95">Why Elites Lion Security</a>
      </div>  
    </div>
  );
};
